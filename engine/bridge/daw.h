 ...
 * input_channel remains the backwards-compatible mono/left source. Empty UID
 * follows system default; explicit missing UID MUST NOT fall back. Set validates
 * syntax without opening hardware (offline preferences allowed).
