...
enum DAWIcon: String, CaseIterable {
    ...
    // Editing / workspace
    case select = "cursorarrow", scissors = "scissors", split = "rectangle.split.2x1", undo = "arrow.uturn.backward", redo = "arrow.uturn.forward", snap = "scope", grid = "grid", browser = "sidebar.left", inspector = "sidebar.right", mixer = "slider.vertical.3", metronome = "metronome"
    ...
    var accessibilityLabel: String {
        ...
        case .metronome: return "Метроном"
