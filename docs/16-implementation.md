...
> Текущий срез 1.38.0: [перестановка дорожек с Undo](65-track-reorder.md). Формат SQLite не менялся: save/open сохраняет текущий порядок дорожек и каждый полный owner subtree, а Undo восстанавливает прежний порядок в памяти до следующего Save.
...
UI пока на русском, без готового RU/EN localization catalog. Нет точного числового ввода gain, автоматического восстановления последнего файла и Finder document association. Удаление и drag reorder дорожек доступны с Undo. Закрытие с несохранённой сессией спрашивает пользователя; silent autosave не заявлен.
