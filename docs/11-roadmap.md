...
| B-018 | P1 | B-008, B-011, B-013 | **Code scope готов:** resizable Studio Pro-inspired arrangement/mixer workspace, pinned track headers, shared zoom/ruler, synchronized vertical scroll, track/bus/master strips, live stereo meters, editable channel/clip inspector, WAV/AU/VST3 browser, persisted dock layout, direct move/trim/fade и единая keyboard command boundary; physical UX/visual acceptance не выполнялась |
