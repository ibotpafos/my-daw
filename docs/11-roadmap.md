...
| B-018 | P1 | B-008, B-011, B-013 | **Code scope и локальный visual QA готовы:** resizable Studio Pro-inspired arrangement/mixer workspace, pinned track headers, shared zoom/ruler, synchronized vertical scroll, track/bus/master strips, live stereo meters, editable channel/clip inspector, WAV/AU/VST3 browser, functional workspace modes, persisted dock layout, direct move/trim/fade и единая keyboard command boundary; физический пользовательский workflow и accessibility audit ещё нужны |
