...
[1.56.0](25-offline-export.md) — BS.1770-4 метр: integrated LUFS и true-peak готового WAV (`daw_measure_wav`), экспортное сообщение показывает цифры; RT-метр мастера — в очереди.
