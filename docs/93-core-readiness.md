...
| P0-03 | Обычная запись поверх проекта | [Срез P0-03](95-normal-duplex-recording.md), issue #23: общий full-duplex для normal/new/take/loop, backing, live MON, preroll, пустой проект, безопасный Stop и Undo/Save/Open. Физический сигнал/latency остаются отдельной приёмкой. |
