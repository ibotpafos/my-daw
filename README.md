...
| Документ | Содержание |
|---|---|
| [78 E2E suite](docs/78-e2e-suite.md) | Сквозные black-box сценарии через публичный C ABI: состав, харнес, запуск (`ctest -L e2e`), ledger покрытия ABI и ручные гейты |
