...
xcrun swiftc -swift-version 6 -warnings-as-errors -parse-as-library apps/macos/AudioHardwareFormat.swift tests/audio_hardware_format_tests.swift -o build/workspace-ui/audio-hardware-form-tests
build/workspace-ui/audio-hardware-form-tests
sources=()
