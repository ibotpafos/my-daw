...
xcrun swiftc -swift-version 6 -sdk "$(xcrun --show-sdk-path)" \
  ...
  apps/macos/MixerRoutingMatrixView.swift apps/macos/DesignSystem/DAWDesignTokens.swift \
  apps/macos/DesignSystem/DAWDataVisuals.swift tests/mixer_ui_tests.swift \
